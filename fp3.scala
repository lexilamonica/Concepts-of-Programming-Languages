...
object fp3 {
  /* EXERCISE 1: complete the following recursive
  definition of a "member" function
  to check whether an element "a" is
  a member of a list of integers "xs".
  Your implementation of "member" MUST
  be recursive and not use the builtin "contains" method
  from the List class.
  EXAMPLES:
  ...
  /*
   EXERCISE 2: complete the following recursive definition of
   an "allEqual" function
 ...
 */
  ...
  */
  ...
  /*EXERCISE 8: write a function "removeDupes2" that behaves like "removeDupes1",
    ...
    encoding).  The counts are paired with each element in the output list.
    EXAMPLE:
